...
contract MemePad is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        /* If burnAddress has >= 100,000,000,000 */ 
        /* don't take burnFee - Do Not burn Excessive Token */
        if(balanceOf(address(0)) < 100 * 10**9 * 10**9){
    ...
    /* Only Owner Functions Starts Here */
